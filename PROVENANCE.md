...
Lead collaboration: ChatGPT (OpenAI). Design of the ref model, operation
semantics, policy evaluation model, receipt chain structure, invariants,
canonical enums, schema constraints, golden test strategy, and compatibility
contract. Iterative refinement of scope boundaries and non-goals.
...
This document reflects the project state as of 2026-04-09 and may be revised.
